...
function TodoItem({ todo }) {
  ...
  return (
    ...
    >
      ...
      {/* Edit, Save Button */}
      <button
        className="inline-flex w-8 h-8 rounded-lg text-sm border cursor-pointer
         border-black/10 justify-center items-center bg-gray-50
          hover:bg-white shrink-0 disabled:opacity-50"
        onClick={() => {
      ...
      {/* Delete Todo Button */}
      <button
        className="inline-flex w-8 h-8 rounded-lg text-sm cursor-pointer
